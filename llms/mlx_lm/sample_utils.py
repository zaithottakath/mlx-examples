...
class BeamSearchSampler:
    ...
    def __call__(self, next_token_logits: mx.array, sequence_weights: mx.array, _):
        ...
        selected_token_ids = mx.take_along_axis(sorted_token_ids, first_occurrence, axis=1)  # shape (batch, self.beams)
        selected_beam_ids = mx.take_along_axis(sorted_beam_ids, first_occurrence, axis=1)  # shape (batch, self.beams)
        selected_scores = mx.take_along_axis(sorted_scores, first_occurrence, axis=1)  # shape (batch, self.beams)
